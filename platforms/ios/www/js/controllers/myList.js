angular.module('myList', [])
  ...
  .controller('bindCarCtrl', function($scope, $stateParams, $http, $ionicActionSheet, $rootScope, $cordovaCamera, $ionicPopover, $cordovaImagePicker, $state, $timeout, getDataService) { //绑定车辆
    $scope.carCode = {}; //车牌号
    $scope.bindCar = {};
  ...
  .controller('mySetCtrl', function($scope, getDataService, $rootScope, $timeout, $state, $ionicPopup, $stateParams, $cordovaImagePicker, $cordovaCamera, $ionicActionSheet) { //我的设置
